			...
			<div style="min-height: 500px;">
				<div style="margin: 30px;">
					...
					<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
						...
						<div class="tab-pane fade" id="ctgr" role="tabpanel" aria-labelledby="ctgr-tab">
							<!-- 연구분야별 통계 -->
							<div id="ctgr_stat" style="margin-top: 20px">
								<p style="font-size: 20px; font-weight: bold; color: #000069">연구분야별 데이터 통계</p>
								<ol class="breadcrumb">
									<li class="breadcrumb-item">
										<p style="font-size: 15px; font-weight: bold; margin-right: 10px; margin-left: 150px">연구분야</p>
									</li>
