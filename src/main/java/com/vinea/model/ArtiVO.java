...
public class ArtiVO {
	...
	public String getArti_volume() {
		return arti_volume;
	}

	public void setArti_volume(String arti_volume) {
		this.arti_volume = arti_volume;
	}
